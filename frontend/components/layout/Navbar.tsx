...
import { Menu, LogOut, ExternalLink, RefreshCw, Wallet } from "lucide-react";
      ...
      <div className="h-full flex items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          {authenticated && address && (
            ...
            >
              <svg className="w-4 h-4 flex-shrink-0 drop-shadow-sm" viewBox="0 0 2000 2000" xmlns="http://www.w3.org/2000/svg">
